...
// 밑 구현부는 줌고정값을 신구대 식물원 좌표로 지정하고 확대 축소 비율 고정값을 줌레벨 2로 지정한것이다
        ...
        MapPolyline polyline4 = new MapPolyline();
            ...
            public void onClick(View v) {
                switch ( v.getId() ) {
                    ...
                    case R.id.button1:
                        ...
                        polyline1.addPoint(MapPoint.mapPointWithGeoCoord(37.43380210000001, 127.08141320000004));
                        polyline2.addPoint(MapPoint.mapPointWithGeoCoord(37.43374990000003,127.08111759999997));

                        //polyline.setLineColor(Color.argb(100, 0, 0, 255));
                        mapView.removeAllPOIItems();

                        polyline1.setLineColor(Color.argb(100, 255, 0, 0));
                        polyline2.setLineColor(Color.argb(100, 255, 0, 0));
                        mapView.addPOIItem(marker21);
                        mapView.addPOIItem(marker1);
                    ...
                    case R.id.button2:
                        ...
                        //mapView.addPolyline(polyline1);
                        polyline3.addPoint(MapPoint.mapPointWithGeoCoord(37.43380210000001, 127.08141320000004)); //입구
                        polyline4.addPoint(MapPoint.mapPointWithGeoCoord(37.43374990000003,127.08111759999997)); //1중앙광장
...
//                        polyline.addPoint(MapPoint.mapPointWithGeoCoord(37.43831869999999,127.07702510000001)); //20라일락원
                        ...
                        polyline3.setLineColor(Color.argb(100, 255, 0, 0));
                        polyline4.setLineColor(Color.argb(100, 255, 0, 0));
                        mapView.removeAllPOIItems();
